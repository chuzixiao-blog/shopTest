...
<div class="sign-con w1200">
    ...
    <div class="sign-ipt f-l">
        <form action="${pageContext.request.contextPath}/user/loginUser.do" method="get">
            <span style="color: red">${param.cuo}</span>
            <%-- 用户名 --%>
            <p>用户名</p>
            <input type="text" name="username" placeholder="用户名" value="${cookie.username.value}"/>
            <%-- 密码 --%>
            <p>密码</p>
            <input type="password" name="password" placeholder="密码" value="${cookie.password.value}"/><br/>
            <input type="checkbox" name="cookie" value="checked" ${cookie.checked.value}/>
            <br/>
            <input type="submit" class="slig-btn" value="登录"/>
        </form>
        <p>没有账号？请<a href="http://localhost/shop/user/toRegistered.do">注册</a><a href="#" class="wj">忘记密码？</a></p>
<%--
        <div class="sign-qx">
