...
<div class="payment-interface w1200">
    ...
    <div class="pay-info">
        ...
        <div class="pay-mima">
            ...
            <button class="mima-btn" onclick="window.location.href='${pageContext.request.contextPath}/order/doPays.do?oid=${param.oid}&pageNow=${param.pageNow}'">确认收货</button>
